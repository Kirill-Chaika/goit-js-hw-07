...
galleryContainer.insertAdjacentHTML('beforeend', galleryCardsSet);
galleryContainer.addEventListener('click', selectGalerryEl);

function selectGalerryEl(event) {
  const galleryImage = event.target.classLict.contains('gallery__image');
  if (!galleryImage){
    return;
  }
